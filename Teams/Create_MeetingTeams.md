# 🎥 Hướng dẫn tạo cuộc họp trực tuyến bằng Microsoft Teams (qua Calendar)
...
![Giao diện lịch trên Teams](img/07.11.2025_1.jpg)
...
## Bước 5: Gửi lời mời họp

- Khi đã kiểm tra xong, chọn **Send (Gửi)**  
...
## Bước 6: Tham gia cuộc họp

Khi đến giờ họp, bạn chỉ cần:
1. Mở **Teams → Calendar**  
...
- Có thể ghi lại cuộc họp (**Record meeting**) nếu cần lưu nội dung trao đổi.  
- Hãy kiểm tra micro và camera trước khi bắt đầu họp.  
- Người ngoài công ty vẫn có thể tham gia họp qua trình duyệt web mà không cần cài Teams.  
- Khi kết thúc, chọn **Leave (Rời khỏi)** để đóng cuộc họp.  

---

**Tiếp theo:** [Chia sẻ và lưu trữ tài liệu trên OneDrive](./onedrive.md)
